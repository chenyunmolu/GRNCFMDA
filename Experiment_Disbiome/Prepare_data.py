...
def microbe_functional_similarity():
    # 修改目录即可
    # 微生物、疾病关联矩阵
    MD = pd.read_csv("../Dataset/Disbiome/mircobe_disease_association_matrix.csv", index_col=0)
    # 疾病语义相似性矩阵
    DS = pd.read_csv("../Dataset/Disbiome/disease_do_similarity.csv", index_col=0)
...
if __name__ == '__main__':
    ...
    microbe_functional_similarity.to_csv("../Dataset/Disbiome/microbe_functional_similarity.csv")
    microbe_GIP_similarity.to_csv("../Dataset/Disbiome/microbe_GIP_similarity.csv")
    disease_GIP_similarity.to_csv("../Dataset/Disbiome/disease_GIP_similarity.csv")
    ...
    microbe_similarity_fusion_matrix.to_csv("../Dataset/Disbiome/microbe_similarity_fusion_matrix.csv")

    disease_do_similarity = pd.read_csv("../Dataset/Disbiome/disease_do_similarity.csv", index_col=0)
    ...
    disease_similarity_fusion_matrix.to_csv("../Dataset/Disbiome/disease_similarity_fusion_matrix.csv")
