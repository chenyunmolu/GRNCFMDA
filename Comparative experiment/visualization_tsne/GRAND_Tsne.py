...
label = pd.read_csv('dataframe/Disbiome_grand_labels.csv', index_col=0)
label = np.array(label).astype(int).flatten()
all_features_input = pd.read_csv('dataframe/Disbiome_grand_input.csv', index_col=0)
