...
学习率:lr
'''
data = pd.read_excel("Parameter_sensitivity_analysis.xlsx", sheet_name='HMDAD_lr', header=0)
lr = data['lr']
auc_values = data['AUC']
...
plt.savefig('hyperparameters_lr.png')
# plt.show()
